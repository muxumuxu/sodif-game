    ...
    a.prototype = {
        ...
        addEvents: function() {
            FLIPCARD.App.addListener("onTapMoreGames", function() {
                if (window.opener) {
                    window.opener.location.href = "https://codecanyon.net/user/ayoub_pro/portfolio";
                    window.close();
                    return;
                }
                window.location.href = "https://codecanyon.net/user/ayoub_pro/portfolio";
            });
...
FLIPCARD.Config.isAdvert = false;
